...
const appPersistConfig = {
  key: 'app',
  storage,
  whitelist: ['isLogin', 'token', 'totalDays', 'selectedCarId', 'userFullname', 'carName', 'alamat', 'instagram', 'tujuanSewa', 'rute', 'jaminan', 'totalPrice', 'tempatAmbil', 'startTime', 'endTime', 'startDate', 'endDate'],
};
