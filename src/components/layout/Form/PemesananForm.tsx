...
import { setAlamat, setCarName, setEndTime, setInstagram, setJaminan, setRute, setStartTime, setTempatAmbil, setTotalPrice, setTujuanSewa, setUserFullname } from '@/store/appSlice';
