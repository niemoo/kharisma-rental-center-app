...
export default async function AdminDashboard() {
  ...
  const handleSubmitUpdate = async () => {
    const updateResponse = await fetch(`https://api.kharisma-rental-center.my.id/admin/profil`, {
      method: 'PUT',
        ...
        <>
          <main className="bg-slate-100 w-full py-10 md:px-20 px-5 h-full overflow-auto">
            <div className="flex justify-between items-center">
              ...
              <AlertDialog>
                <AlertDialogTrigger className="px-4 py-2 bg-blue-500 hover:bg-white hover:text-blue-500 border border-blue-500 text-white rounded-lg">Update Profil Admin</AlertDialogTrigger>
                <AlertDialogContent>
                  <AlertDialogHeader>
                    <AlertDialogTitle>Update Profil Admin</AlertDialogTitle>
                    <AlertDialogDescription>
                      <hr className="mb-5" />
                      <div className="grid gap-2 mb-4 mt-5">
                        <Label className="block text-gray-700">Username</Label>
                        <Input type="text" ref={usernameRef} placeholder="Masukkan Username Terbaru" />
                      </div>
                      <div className="grid gap-2 mb-4 mt-5">
